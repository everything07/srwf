    ...
    <main class="container mt-4">
        <div class="card border-info mb-3 mx-auto p-4">
            ...
            <form action="/crewing_diary/confirm" method="POST">
                ...
                <input class="form-control my-2" type="text" name="post[title]" value="{{ old('post.title') }}">
                <label class="form-label fs-5 mt-3">本文</label>
                <textarea class="form-control my-2" rows="10" cols="33" name="post[body]">{{ old('post.body') }}</textarea>
